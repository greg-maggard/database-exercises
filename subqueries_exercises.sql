...
FROM
    employees
WHERE
    to_date > NOW() -- COME BACK AND FIX THIS LINE
...
SELECT COUNT(*) as 'Number of Salaries', COUNT(*) / (SELECT COUNT(*) FROM salaries WHERE to_date > NOW()) * 100 as 'Percentage'
FROM salaries
...
# What percentage? 
# count of numerator/count of overall (denominator) * 100
